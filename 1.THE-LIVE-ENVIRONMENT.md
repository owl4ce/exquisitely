...
> BtrFS as the name suggest is chosen because if you are dual-booting Microsoft Windows, there is
[WinBtrfs](https://github.com/maharmstone/btrfs) available to install on Windows system. This is wisdom.
...
file. Those options must be placed as kernel parameter on [first-mount](#37-bootloader-less). The `/mnt/etc/fstab` file
