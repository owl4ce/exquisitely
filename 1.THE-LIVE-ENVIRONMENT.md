...
balanced optimization and linux-firmware for compatibility fixes. If your machine uses Intel SoC, append -intel suffix
to linux-firmware package to **only install** the Intel firmware.
